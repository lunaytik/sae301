const cb = document.getElementById('adresse_cb_cardNum');
const nomentier = document.getElementById('adresse_cb_cardName');
const mois = document.getElementById('adresse_cb_cardMois');
const annee = document.getElementById('adresse_cb_cardAnnee');
